...
class salim_fiil_tefil_babi:
    ...
    def yazdir(self):
        ...
        \n{"İsm-i Fail    : "} {self.salim_fiil_tefil_babi_ismi_fail} \
        \n{"İsm-i Meful   : "} {self.salim_fiil_tefil_babi_emri_hazir} \
        \n{"Masdar        : "} {self.salim_fiil_tefil_babi_mastar} \
        \n{"Mazi Meçhul   : "} {self.salim_fiil_tefil_babi_mazi_mechul_gaib} \
        \n{"Muzari Meçhul : "} {self.salim_fiil_tefil_babi_muzari_mechul_gaib} \
        \n{"İsm-i Meful   : "} {self.salim_fiil_tefil_babi_ismi_meful}')
